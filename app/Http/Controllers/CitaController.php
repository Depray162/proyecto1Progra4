...
class CitaController extends Controller
{
    ...
    public function indexPacCita($id)
    {
        $citas = cita::with(["paciente", "medico", "historial"])->where("idPaciente" , "=", $id)->get();
    ...
    public function storePacCita(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'motivo' => 'required',
            'area' => 'required',
    ...
    public function showPacCita($id)
    {
        $cita = Cita::with(["paciente", "medico", "historial"])->where("idPaciente", "=", $id)->first();
    ...
    public function updatePacCita(Request $request, $id)
    {
        $cita = cita::find($id);
    ...
    public function destroyPacCita($id)
    {
        $cita = cita::find($id);
